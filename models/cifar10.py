...
# https://github.com/huawei-noah/Efficient-Computing/blob/master/Data-Efficient-Model-Compression/DFND/resnet.py
...
def cifar10_res18(num_classes=10):
    return nn.Sequential(
        CIFAR10Normalize(),
        resnet18(num_classes=num_classes))
    
def cifar10_res34(num_classes=10):
    return nn.Sequential(
        CIFAR10Normalize(),
        resnet34(num_classes=num_classes))
    
def cifar10_res50(num_classes=10):
    return nn.Sequential(
        CIFAR10Normalize(),
        resnet50(num_classes=num_classes))
    
def cifar10_res101(num_classes=10):
    return nn.Sequential(
        CIFAR10Normalize(),
        resnet101(num_classes=num_classes))
    
def cifar10_res152(num_classes=10):
    return nn.Sequential(
        CIFAR10Normalize(),
        resnet152(num_classes=num_classes))
    
    
def cifar100_res18(num_classes=100):
    return nn.Sequential(
        CIFAR100Normalize(),
        resnet18(num_classes=num_classes))
    
def cifar100_res34(num_classes=100):
    return nn.Sequential(
        CIFAR100Normalize(),
        resnet34(num_classes=num_classes))
    
def cifar100_res50(num_classes=100):
    return nn.Sequential(
        CIFAR100Normalize(),
        resnet50(num_classes=num_classes))
    
def cifar100_res101(num_classes=100):
    return nn.Sequential(
        CIFAR100Normalize(),
        resnet101(num_classes=num_classes))
    
def cifar100_res152(num_classes=100):
    return nn.Sequential(
        CIFAR100Normalize(),
        resnet152(num_classes=num_classes))
...
models = {
    ...
    'res34': cifar10_res34,
    'res50': cifar10_res50,
    'res101': cifar10_res101,
    'res152': cifar10_res152
}

models_cifar100 = {
    'res18': cifar100_res18,
    'res34': cifar100_res34,
    'res50': cifar100_res50,
    'res101': cifar100_res101,
    'res152': cifar100_res152
}
