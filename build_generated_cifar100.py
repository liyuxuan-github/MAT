...
d=torch.load('/home/yhguo/yuxuan/watermarking/yg_margin_based_watermarking_codes/experiments/cifar100_res18_none_100_clean_24000/checkpoints/checkpoint_199.pt')
...
file=open('./datasets/cifar100_only_clean_dataset.pickle','wb')
pickle.dump(only_clean,file)
file.close()


file=open('./datasets/cifar100_generated_dataset.pickle','wb')
pickle.dump(d,file)
file.close()

file=open('./datasets/cifar100_generated_editedset.pickle','wb')
pickle.dump(q,file)
file.close()
