...
if __name__ == "__main__":
    ...
    if args.labelmode=='hard':
        ...
        output_dir = os.path.join(args.exp_name, exp_name, 'finetune_hard_label'+args.additional_message)
    
    elif args.labelmode=='soft':

        output_dir = os.path.join(args.exp_name, exp_name, 'finetune'+args.additional_message)
