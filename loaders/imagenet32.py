...
#
def get_imagenet32_loaders(root='/home/yhguo/yuxuan/imagenet32/'):
  ...
  atrain_loader = DataLoader(atrain_set, batch_size=128, shuffle=True, num_workers=2, drop_last=True)
  aval_loader = DataLoader(aval_set, batch_size=128, shuffle=False, num_workers=2, drop_last=False)
  test_loader = DataLoader(test_set, batch_size=128, shuffle=False, num_workers=2, drop_last=False)
  return train_loader, val_loader, atrain_loader, aval_loader, test_loader 
