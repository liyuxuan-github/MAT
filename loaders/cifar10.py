...
def get_cifar10_loaders(root='../data', config=None):
    ...
    atrain_loader = DataLoader(atrain_set, batch_size=64, shuffle=True, num_workers=2, drop_last=True)
    aval_loader = DataLoader(aval_set, batch_size=64, shuffle=False, num_workers=2, drop_last=False)
